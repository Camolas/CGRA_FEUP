	...
	class LightingScene extends CGFscene 
	{
		...
		init(application) 
		{
			...
			// Scene elements
			/*this.prism = new MyPrism(this,30,1);
			...
			this.tableAppearance.setAmbient(0.2,0.2,0.1,1);
			this.tableAppearance.setDiffuse(0.8,0.8,0.8,1);
			this.tableAppearance.setSpecular(0.1,0.2,0.3,1);
			this.tableAppearance.setShininess(120);
/*
			this.floorAppearance = new CGFappearance(this);
			this.floorAppearance.loadTe*/
		...
		display() 
		{
			...
			/*this.pushMatrix();
				...
				this.rotate(-90 * degToRad, 1, -1.5, 0);
				//this.scale(5, 5, 2);
