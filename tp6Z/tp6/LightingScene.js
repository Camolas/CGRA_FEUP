...
LightingScene.prototype.update = function(currTime) {
	...
	if(distanceVector( this.drone.coordX, this.drone.coordY, this.drone.coordZ, 3, 0.5, 3) < 1.60) this.cubeAttached = true;
	if(distanceVector( this.drone.coordX, this.drone.coordY, this.drone.coordZ, 12, 0.5, 3) < 1.71) {
		this.cubeAttached = false;
	...
	this.drone.update(this.deltaTime, type);
};
...
LightingScene.prototype.display = function() {
	...
	this.pushMatrix();
		...
		if(this.cubeAttached == true) {
			this.translate(this.drone.coordX, this.drone.coordY-1.5, this.drone.coordZ);
